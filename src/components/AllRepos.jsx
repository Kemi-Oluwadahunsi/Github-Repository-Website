...
const AllRepos = () => {
  ...
  return (
    <div className="px-[5rem] py-[3rem] flex flex-col gap-[3rem] justify-center items-center">
      <h2 className="text-4xl  font-extrabold">My Repositories</h2>
      ...
      <div className="flex justify-between items-center w-full">
        ...
        <span className="font-medium text-lg basis-[30%]">
          ...
          ? filteredRepos.map((repo) => (
              ...
              >
                ...
                <div className=" flex flex-col gap-4 px-[2em] py-[2em] shadow-2xl h-full w-full rounded-2xl">
                  ...
                  <span className="text-lg pl-[2rem]">{repo.lastUpdated}</span>
                </div>
              </div>
            ))
